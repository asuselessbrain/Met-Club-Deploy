...
type TOCPageProps = {
  go: React.Dispatch<React.SetStateAction<PageKey>>;
};
...
const NAV: NavItem[] = [
  ...
  { key: "ch1", label: "অধ্যায় ১: আগাম পদক্ষেপ" },
  { key: "ch2", label: "অধ্যায় ২: ঝুঁকি বোঝা" },
  { key: "ch3", label: "অধ্যায় ৩: প্রভাব-ভিত্তিক পূর্বাভাস" },
  { key: "ch4", label: "অধ্যায় ৪: সতর্কীকরণ ব্যবস্থা" },
  { key: "ch5", label: "অধ্যায় ৫: Citizen Science" },
...
function TOCPage({ go }: TOCPageProps) {
  const rows: TocRow[] = [
    { icon: "🌟", title: "অধ্যায় ১ — আগাম পদক্ষেপের ভিত্তি", desc: '"অপেক্ষা" আর "প্রস্তুতি"-র পার্থক্য।', pages: "৫–৮", key: "ch1" },
    { icon: "🔎", title: "অধ্যায় ২ — ঝুঁকি বোঝা (EWS স্তম্ভ ১)", desc: "বিপদ, ঝুঁকিপূর্ণতা ও সম্মুখীনতা — ঝুঁকির সূত্র।", pages: "৯–১২", key: "ch2" },
    { icon: "🎨", title: "অধ্যায় ৩ — প্রভাব-ভিত্তিক পূর্বাভাস (EWS স্তম্ভ ২)", desc: '"আবহাওয়া কী করবে" — রং-সংকেতে বোঝা।', pages: "১৩–১৬", key: "ch3" },
    { icon: "📢", title: "অধ্যায় ৪ — আগাম সতর্কীকরণ ব্যবস্থা (EWS স্তম্ভ ৩+৪)", desc: "সতর্কবার্তা কীভাবে মানুষের কাছে পৌঁছায় ও কাজে রূপ নেয় (CPP, সংকেত, ৩৩৩)।", pages: "১৭–২১", key: "ch4" },
    { icon: "🙋", title: "অধ্যায় ৫ — তুমিই বিজ্ঞানী (Citizen Science)", desc: "নিজের তথ্য সংগ্রহ করে কীভাবে গোটা ব্যবস্থাকে নিখুঁত করা যায়।", pages: "২২–২৪", key: "ch5" },
