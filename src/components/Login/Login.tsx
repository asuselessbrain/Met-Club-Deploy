    ...
    <form className="space-y-4 md:space-y-6 lg:space-y-2 xl:space-y-6" onSubmit={handleSubmit(onSubmit)}>
        <div>
            ...
            <input
                ...
                className={`bg-white/40 border border-slate-300/70 text-slate-900 rounded-xl block w-full p-3 focus:ring-2 focus:ring-red-300 focus:border-red-300 focus:outline-none placeholder:text-slate-500 ${errors.studentId ? "border-red-500" : "border-slate-300/70"}`}
            />
